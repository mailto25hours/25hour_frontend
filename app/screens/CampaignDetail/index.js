...
export default function CampaignDetail({ navigation }) {
        ...
        <ScrollView
          ...
          <View
            ...
            <Text body2 style={{ lineHeight: 20 }}>
              काठमाण्डौ जिल्ला नागार्जुन नगरपालिका रामकोटमा सितापाईला- भिमढुङ्गा सडक देखि करिब १ कि.मि. बायाँ
              (देब्रे) तर्फ ३ फिटको गोरेटो बाटोमा रहेको जग्गा एकदमै सस्तोमा बिक्रीमा छ । Emergency भएको भएर ।
            </Text>
            <View
              style={{
                paddingVertical: 20,
